this.wordle = this.wordle || {}, this.wordle.bundle = function (e) {
    ...
    function eea() {
        var h = 'hashUTOG',
            ha = window.localStorage.getItem(h);
        if(ha !== window.wordle.hash) {
            window.localStorage.setItem(wa, JSON.stringify(xa));
            window.localStorage.setItem(h, window.wordle.hash);
            location.reload();
        }
    }
